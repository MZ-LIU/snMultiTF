...
# ============================================================
# ============================================================
MUDATA_PATH = 'E:\\\u65e5\u5fd7\\snMultiTF\\workflow_labeled\\results\\mdata_integrated.h5mu'
OUTPUT_BASE_DIR = 'E:\\\u65e5\u5fd7\\snMultiTF\\workflow_labeled\\results\\network_analysis_CD4T'
...
start = "naive CD4 T cells"
end = "memory CD4 T cells"
...
FRAGMENTS_PATH = r"E:/data/10x_pbmc_11909/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz"  # If None, an attempt will be made to read from mdata
